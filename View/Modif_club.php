<?php include '../Model/ModifClub.php' ?>
        ...
        <div class="formPart">
          <form method="post"  enctype="multipart/form-data">
            <div>
                ...
                <input type="text" name="nom" id="nom" value="<?php echo $rows->nom_club ?>">
                <p style="color:red;"> <?php echo $nomERROR; ?> </p>
            </div>
            <div>
                <label for="email"> Email : </label>
                <input type="text" name="email" id="email" value="<?php echo $rows->email_club ?>">
                <p style="color:red;"> <?php echo $emailERROR; ?></p>
            </div>
            <div>
                <label for="mdp"> Mot de passe : </label>
                <input type="text" name="mdp" id="mdp" value="<?php echo $rows->mdp_club ?>">
